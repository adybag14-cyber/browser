...
$readyUrl = "http://127.0.0.1:$Port/auth-stylesheet-import-anonymous-page.html"
...
try {
  ...
  if (-not $loaded) { throw "stylesheet import anonymous probe did not observe root, child, and loaded beacons" }
} catch {
