...
from headed_interaction_probe_launch_audit import EXPECTATIONS, audit


class HeadedInteractionProbeLaunchAuditTests(unittest.TestCase):
    ...
    def test_audit_keeps_popup_form_and_upload_surfaces_in_coverage(self) -> None:
        covered_labels = {expectation["label"] for expectation in EXPECTATIONS}
        self.assertTrue(
            {
                "file_upload_common_headed_launch",
                "enter_submit_probe_headed_launch",
                "label_click_probe_headed_launch",
                "popup_background_timer_headed_launch",
                "popup_form_enter_headed_launch",
                "popup_form_post_headed_launch",
                "inline_flow_probe_headed_launch",
