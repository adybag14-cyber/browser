...
from headed_stateful_localhost_launch_audit import EXPECTATIONS, audit


class HeadedStatefulLocalhostLaunchAuditTests(unittest.TestCase):
    ...
    def test_audit_keeps_persistence_and_interaction_families_covered(self) -> None:
        covered_labels = {expectation["label"] for expectation in EXPECTATIONS}
        self.assertTrue(
            {
                "sessionstorage_common_headed_launch",
                "cookie_common_headed_launch",
                "localstorage_common_headed_launch",
                "indexeddb_common_headed_launch",
                "find_probe_headed_launch",
                "rendered_link_dom_headed_launch",
