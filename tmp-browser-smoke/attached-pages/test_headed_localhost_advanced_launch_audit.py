...
from headed_localhost_advanced_launch_audit import EXPECTATIONS, audit


class HeadedLocalhostAdvancedLaunchAuditTests(unittest.TestCase):
    ...
    def test_audit_keeps_websocket_font_and_zoom_coverage(self) -> None:
        covered_labels = {expectation["label"] for expectation in EXPECTATIONS}
        self.assertTrue(
            {
                "websocket_subprotocol_headed_launch",
                "websocket_binary_close_headed_launch",
                "font_auth_headed_launch",
                "font_anonymous_headed_launch",
