...
EXPECTATIONS = (
    ...
    {
        "path": "docs/ISSUE3_WINDOWS_REPLAY_ATTACHED_HTML_QUICKSTART.md",
        "snippet": "docs/ISSUE3_REPLAY_ROUTE_BUNDLE_FIRST_BRIDGE.md",
        "purpose": "The replay-attached quickstart keeps the bundle-first bridge note visible.",
    },
    {
        "path": "docs/ISSUE3_WINDOWS_REPLAY_ATTACHED_HTML_QUICKSTART.md",
    ...
    {
        "path": "scripts/windows/check_google_issue3_windows_replay_attached_html_quickstart_validation_surface.ps1",
        "snippet": '(New-ValidationReference -Path "docs/ISSUE3_REPLAY_ROUTE_BUNDLE_FIRST_BRIDGE.md"',
        "purpose": "The PowerShell surface checker tracks the bundle-first bridge note as a required reference.",
    },
    {
        "path": "scripts/windows/check_google_issue3_windows_replay_attached_html_quickstart_validation_surface.ps1",
    ...
    {
        "path": "scripts/windows/check_google_issue3_windows_replay_attached_html_quickstart_validation_surface.ps1",
        "snippet": '(New-ValidationContentExpectation -Path "docs/ISSUE3_WINDOWS_REPLAY_ATTACHED_HTML_QUICKSTART.md" -Snippet \'docs/ISSUE3_REPLAY_ROUTE_BUNDLE_FIRST_BRIDGE.md\'',
        "purpose": "The PowerShell surface checker fails if the replay note drops the bundle-first bridge note.",
    },
    {
        "path": "scripts/windows/check_google_issue3_windows_replay_attached_html_quickstart_validation_surface.ps1",
