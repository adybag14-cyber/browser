...
FIXTURE_FILES = {
    ...
    "docs/ISSUE3_PROGRESS_TRACKER_ROUTE.md|docs/ISSUE3_SAVED_ARCHIVE_INTEGRITY_ROUTE.md|"
    "docs/ISSUE3_PROGRESS_TRACKER_ROUTE.md|show_issue3_saved_archive_integrity_route.sh|"
    ...
    "scripts/linux/show_issue3_progress_tracker_route.sh|saved_archive_integrity_route|"
    "scripts/linux/show_issue3_progress_tracker_route.sh|show_issue3_saved_archive_integrity_route.sh|"
...
class Issue3ProgressTrackerArchiveIntegrityRouteSurfaceTest(unittest.TestCase):
    @classmethod
    ...
    def test_progress_note_keeps_archive_integrity_handoff_visible(self) -> None:
        for fragment in (
            "issue `#11`",
            "docs/ISSUE3_SAVED_ARCHIVE_INTEGRITY_ROUTE.md",
            "show_issue3_saved_archive_integrity_route.sh",
    ...
    def test_surface_checker_keeps_archive_integrity_contract_fragments_visible(self) -> None:
        for fragment in (
            "bash scripts/linux/check_issue3_progress_tracker_route_surface.sh",
            "--repo-root /path/to/browser-repo",
            "--json",
    ...
    def test_route_printer_keeps_archive_integrity_followup_visible(self) -> None:
        for fragment in (
