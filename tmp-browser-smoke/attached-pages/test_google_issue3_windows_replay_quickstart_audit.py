...
DRIFT_CASES = (
    ...
    (
        "missing_windows_route_surface_repo_root_doc_command",
        "docs/ISSUE3_WINDOWS_REPLAY_ATTACHED_HTML_QUICKSTART.md",
    ...
    (
        "missing_validation_router_attached_html_surface_repo_root_doc_command",
        "docs/ISSUE3_WINDOWS_REPLAY_ATTACHED_HTML_QUICKSTART.md",
    ...
    (
        "missing_bundle_suite_surface_wiring",
        "scripts/windows/show_google_issue3_windows_replay_quickstart.ps1",
    ...
    (
        "missing_bundle_suite_surface_guidance",
        "scripts/windows/show_google_issue3_windows_replay_quickstart.ps1",
    ...
    (
        "missing_bundle_suite_surface_output",
        "scripts/windows/show_google_issue3_windows_replay_quickstart.ps1",
    ...
    (
        "missing_bundle_suite_note_output",
        "scripts/windows/show_google_issue3_windows_replay_quickstart.ps1",
