...
from headed_image_runtime_probe_launch_audit import EXPECTATIONS, audit


class HeadedImageRuntimeProbeLaunchAuditTests(unittest.TestCase):
    ...
    def test_audit_keeps_policy_and_redirect_probes_in_coverage(self) -> None:
        covered_labels = {expectation["label"] for expectation in EXPECTATIONS}
        self.assertTrue(
            {
                "image_runtime_policy_probe_headed_launch",
                "image_runtime_redirect_probe_headed_launch",
                "image_runtime_module_auth_anonymous_probe_headed_launch",
