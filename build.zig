...
pub fn build(b: *Build) !void {
    ...
    if (target_class == .bare_metal and target.result.os.tag == .windows) {
        ...
        const release_download_cmd = b.addSystemCommand(&.{
            "powershell",
            "-NoProfile",
            "-ExecutionPolicy",
            "Bypass",
        ...
        release_download_cmd.step.dependOn(b.getInstallStep());
        release_download_cmd.step.dependOn(&release_policy_cmd.step);

        const release_shell_cmd = b.addSystemCommand(&.{
            "powershell",
            "-NoProfile",
            "-ExecutionPolicy",
            "Bypass",
        ...
        release_shell_cmd.step.dependOn(b.getInstallStep());
        release_shell_cmd.step.dependOn(&release_download_cmd.step);

        const release_tabs_restore_cmd = b.addSystemCommand(&.{
            "powershell",
            "-NoProfile",
            "-ExecutionPolicy",
            "Bypass",
