...
declare -a CONTENT_EXPECTATIONS=(
    ...
    "docs/ISSUE3_RUNTIME_REENTRY_GATES.md|scripts/check_issue3_saved_archive_integrity.py|The runtime re-entry gates keep the archive-integrity helper visible before focused Zig validation."
