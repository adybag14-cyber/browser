...
declare -a REFERENCE_PATHS=(
    ...
    "docs/ISSUE3_STAGED_RUST_TOOLCHAIN_CANDIDATES_ROUTE.md|file|Staged-Rust route note that should stay visible when issue #11 is narrowing staged toolchain reuse before archive restore."
    ...
    "docs/ISSUE3_STAGED_ZIG_TOOLCHAIN_CANDIDATES_ROUTE.md|file|Staged-Zig route note that should stay visible when issue #11 is narrowing staged toolchain reuse before archive restore."
    ...
    "scripts/linux/check_issue3_staged_rust_toolchain_candidates_route_surface.sh|file|Fail-fast surface checker for the staged-Rust route used when issue #11 is narrowing staged candidate reuse before archive restore."
    "scripts/linux/show_issue3_staged_rust_toolchain_candidates_route.sh|file|Staged-Rust route printer used when issue #11 is narrowing staged candidate reuse before archive restore."
    ...
    "scripts/linux/check_issue3_staged_zig_toolchain_candidates_route_surface.sh|file|Fail-fast surface checker for the staged-Zig route used when issue #11 is narrowing staged candidate reuse before archive restore."
    "scripts/linux/show_issue3_staged_zig_toolchain_candidates_route.sh|file|Staged-Zig route printer used when issue #11 is narrowing staged candidate reuse before archive restore."
...
declare -a CONTENT_EXPECTATIONS=(
    ...
    "docs/ISSUE3_PROGRESS_TRACKER_ROUTE.md|docs/ISSUE3_STAGED_RUST_TOOLCHAIN_CANDIDATES_ROUTE.md|The progress-tracker note keeps the staged-Rust route note visible when the immediate slice is staged candidate reuse."
    "docs/ISSUE3_PROGRESS_TRACKER_ROUTE.md|check_issue3_staged_rust_toolchain_candidates_route_surface.sh|The progress-tracker note keeps the staged-Rust route surface visible before broader saved-Rust archive or bridge routes are trusted."
    "docs/ISSUE3_PROGRESS_TRACKER_ROUTE.md|show_issue3_staged_rust_toolchain_candidates_route.sh|The progress-tracker note keeps the staged-Rust route printer visible before broader saved-Rust archive or bridge routes are trusted."
    ...
    "docs/ISSUE3_PROGRESS_TRACKER_ROUTE.md|docs/ISSUE3_STAGED_ZIG_TOOLCHAIN_CANDIDATES_ROUTE.md|The progress-tracker note keeps the staged-Zig route note visible when the immediate slice is staged candidate reuse."
    "docs/ISSUE3_PROGRESS_TRACKER_ROUTE.md|check_issue3_staged_zig_toolchain_candidates_route_surface.sh|The progress-tracker note keeps the staged-Zig route surface visible before broader saved-Zig or recovery routes are trusted."
    "docs/ISSUE3_PROGRESS_TRACKER_ROUTE.md|show_issue3_staged_zig_toolchain_candidates_route.sh|The progress-tracker note keeps the staged-Zig route printer visible before broader saved-Zig or recovery routes are trusted."
    ...
    "scripts/linux/show_issue3_progress_tracker_route.sh|show_issue3_staged_rust_toolchain_candidates_route.sh|The route printer still exposes the staged-Rust route printer."
    ...
    "scripts/linux/show_issue3_progress_tracker_route.sh|show_issue3_staged_zig_toolchain_candidates_route.sh|The route printer still exposes the staged-Zig route printer."
