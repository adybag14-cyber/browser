...
declare -a REFERENCE_PATHS=(
    ...
    "scripts/linux/run_issue11_nested_workspace_saved_memory_preflight.sh|file|Nested-workspace saved-Memory rerun helper that should stay visible before the tracker widens into saved-Rust or broader re-entry follow-ups."
    ...
    "docs/ISSUE3_STAGED_RUST_TOOLCHAIN_CANDIDATES_ROUTE.md|file|Staged-Rust route note that should stay visible when issue #11 is checking whether a reusable Rust 1.79.x toolchain already exists under ../toolchains."
    ...
    "docs/ISSUE3_STAGED_ZIG_TOOLCHAIN_CANDIDATES_ROUTE.md|file|Staged-Zig route note that should stay visible when issue #11 is checking whether a reusable branch-compatible Zig candidate already exists under ../toolchains."
    ...
    "scripts/linux/check_issue3_staged_rust_toolchain_candidates_route_surface.sh|file|Fail-fast surface checker for the staged-Rust route used when issue #11 is checking whether archive restore can be skipped."
    "scripts/linux/show_issue3_staged_rust_toolchain_candidates_route.sh|file|Staged-Rust route printer used when issue #11 is checking whether archive restore can be skipped."
    ...
    "scripts/linux/check_issue3_staged_zig_toolchain_candidates_route_surface.sh|file|Fail-fast surface checker for the staged-Zig route used when issue #11 is checking whether archive restore can be skipped."
    "scripts/linux/show_issue3_staged_zig_toolchain_candidates_route.sh|file|Staged-Zig route printer used when issue #11 is checking whether archive restore can be skipped."
...
declare -a CONTENT_EXPECTATIONS=(
    ...
    "docs/ISSUE3_PROGRESS_TRACKER_ROUTE.md|docs/ISSUE3_STAGED_RUST_TOOLCHAIN_CANDIDATES_ROUTE.md|The progress-tracker note keeps the staged-Rust route note visible before archive restore is retried."
    "docs/ISSUE3_PROGRESS_TRACKER_ROUTE.md|check_issue3_staged_rust_toolchain_candidates_route_surface.sh|The progress-tracker note keeps the staged-Rust route surface visible."
    "docs/ISSUE3_PROGRESS_TRACKER_ROUTE.md|show_issue3_staged_rust_toolchain_candidates_route.sh|The progress-tracker note keeps the staged-Rust route printer visible."
    ...
    "docs/ISSUE3_PROGRESS_TRACKER_ROUTE.md|docs/ISSUE3_STAGED_ZIG_TOOLCHAIN_CANDIDATES_ROUTE.md|The progress-tracker note keeps the staged-Zig route note visible before archive restore is retried."
    "docs/ISSUE3_PROGRESS_TRACKER_ROUTE.md|check_issue3_staged_zig_toolchain_candidates_route_surface.sh|The progress-tracker note keeps the staged-Zig route surface visible."
    "docs/ISSUE3_PROGRESS_TRACKER_ROUTE.md|show_issue3_staged_zig_toolchain_candidates_route.sh|The progress-tracker note keeps the staged-Zig route printer visible."
    ...
    "scripts/linux/show_issue3_progress_tracker_route.sh|run_issue11_nested_workspace_saved_memory_preflight.sh|The route printer keeps the nested-workspace saved-Memory preflight helper visible."
    "scripts/linux/show_issue3_progress_tracker_route.sh|nested_workspace_saved_memory_preflight|The route printer JSON output exposes the nested-workspace saved-Memory preflight key explicitly."
    "scripts/linux/show_issue3_progress_tracker_route.sh|Nested-workspace saved-Memory preflight:|The route printer keeps the nested-workspace saved-Memory preflight visible in the human-readable handoff."
    ...
    "scripts/linux/show_issue3_progress_tracker_route.sh|check_issue3_staged_rust_toolchain_candidates_route_surface.sh|The route printer still exposes the staged-Rust route surface check."
    "scripts/linux/show_issue3_progress_tracker_route.sh|staged_rust_route_surface|The route printer JSON output exposes the staged-Rust route surface key explicitly."
    "scripts/linux/show_issue3_progress_tracker_route.sh|show_issue3_staged_rust_toolchain_candidates_route.sh|The route printer still exposes the staged-Rust route."
    "scripts/linux/show_issue3_progress_tracker_route.sh|staged_rust_toolchain_candidates_route|The route printer JSON output exposes the staged-Rust route key explicitly."
    "scripts/linux/show_issue3_progress_tracker_route.sh|Staged Rust route surface check:|The route printer keeps the staged-Rust route surface visible in the human-readable handoff."
    "scripts/linux/show_issue3_progress_tracker_route.sh|Staged Rust candidates route:|The route printer keeps the staged-Rust route visible in the human-readable handoff."
    ...
    "scripts/linux/show_issue3_progress_tracker_route.sh|check_issue3_staged_zig_toolchain_candidates_route_surface.sh|The route printer still exposes the staged-Zig route surface check."
    "scripts/linux/show_issue3_progress_tracker_route.sh|staged_zig_route_surface|The route printer JSON output exposes the staged-Zig route surface key explicitly."
    "scripts/linux/show_issue3_progress_tracker_route.sh|show_issue3_staged_zig_toolchain_candidates_route.sh|The route printer still exposes the staged-Zig route."
    "scripts/linux/show_issue3_progress_tracker_route.sh|staged_zig_toolchain_candidates_route|The route printer JSON output exposes the staged-Zig route key explicitly."
    "scripts/linux/show_issue3_progress_tracker_route.sh|Staged Zig route surface check:|The route printer keeps the staged-Zig route surface visible in the human-readable handoff."
