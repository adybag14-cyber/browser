...
TOOLCHAIN_MATCH_COMMAND="bash $(format_shell_arg "${ZIG_TOOLCHAIN_MATCH_SCRIPT}") --repo-root $(format_shell_arg "${REPO_ROOT}") --toolchains-root $(format_shell_arg "${TOOLCHAINS_ROOT}")"
