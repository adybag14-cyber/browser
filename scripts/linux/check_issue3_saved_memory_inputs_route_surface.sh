...
declare -a REFERENCE_PATHS=(
    ...
    "docs/ISSUE3_STAGED_ZIG_TOOLCHAIN_CANDIDATES_ROUTE.md|file|Dedicated staged Zig candidate route note for checking whether a matching staged toolchain already exists before archive restore."
    "docs/ISSUE3_WORKSPACE_CONTEXT_ROUTE.md|file|Workspace-context note for nested or restored checkouts that still need the saved-Memory route to resolve shared roots honestly."
    "docs/ISSUE3_RESTORED_HELPER_SURFACE_SYNC_ROUTE.md|file|Narrower restored-helper-surface sync route note for saved snapshots that may lag the live issue #11 helper root."
    "docs/ISSUE3_SAVED_RUST_TOOLCHAIN_ROUTE.md|file|Saved Rust toolchain route note for restoring or exporting the saved Rust surface."
    "docs/ISSUE3_SAVED_RUST_BUILD_READINESS_ROUTE.md|file|Saved Rust build-readiness bridge note for Linux or WSL reruns."
    "docs/ISSUE3_SAVED_RUST_ARCHIVE_CANDIDATES_ROUTE.md|file|Saved Rust archive candidate route note for picking the next Rust archive restore path."
    "docs/ISSUE3_STAGED_RUST_TOOLCHAIN_CANDIDATES_ROUTE.md|file|Dedicated staged Rust candidate route note for checking whether a matching staged toolchain already exists before archive restore."
    ...
    "scripts/linux/run_issue11_nested_workspace_saved_memory_preflight.sh|file|Compact issue #11 nested-workspace wrapper that reruns the saved-Memory preflight with surfaced shared roots."
    "scripts/linux/check_issue3_workspace_context_route_surface.sh|file|Fail-fast surface checker for the workspace-context route that unusual saved-Memory layouts depend on first."
    "scripts/linux/show_issue3_workspace_context_route.sh|file|Compact route printer for the workspace-context handoff used before direct saved-Memory reruns in unusual layouts."
    "scripts/check_issue3_workspace_context.py|file|Workspace-context helper that resolves the nearest shared roots before saved-Memory follow-up work."
    ...
    "scripts/linux/check_issue3_staged_zig_toolchain_candidates_route_surface.sh|file|Fail-fast surface checker for the staged Zig candidate follow-up route."
    "scripts/linux/show_issue3_staged_zig_toolchain_candidates_route.sh|file|Compact route printer for the staged Zig candidate follow-up."
    ...
    "scripts/check_issue3_restored_helper_surface_sync.py|file|Narrower restored-helper comparison helper used when the saved-Memory route has to verify live-vs-restored helper drift."
    "scripts/linux/check_issue3_restored_helper_surface_sync_route_surface.sh|file|Fail-fast surface checker for the restored-helper-surface sync follow-up route."
    "scripts/linux/show_issue3_restored_helper_surface_sync_route.sh|file|Compact route printer for the restored-helper-surface sync follow-up."
    "scripts/linux/check_issue3_staged_rust_toolchain_candidates_route_surface.sh|file|Fail-fast surface checker for the staged Rust candidate follow-up route."
    "scripts/linux/show_issue3_staged_rust_toolchain_candidates_route.sh|file|Compact route printer for the staged Rust candidate follow-up."
...
declare -a CONTENT_EXPECTATIONS=(
    ...
    "docs/ISSUE3_SAVED_MEMORY_INPUTS_ROUTE.md|docs/ISSUE3_SAVED_ZIG_ARCHIVE_CANDIDATES_ROUTE.md|The saved-Memory-inputs note keeps the saved Zig archive candidate handoff visible."
    "docs/ISSUE3_SAVED_MEMORY_INPUTS_ROUTE.md|docs/ISSUE3_STAGED_ZIG_TOOLCHAIN_CANDIDATES_ROUTE.md|The saved-Memory-inputs note keeps the staged Zig candidate handoff visible."
    "docs/ISSUE3_SAVED_MEMORY_INPUTS_ROUTE.md|docs/ISSUE3_WORKSPACE_CONTEXT_ROUTE.md|The saved-Memory-inputs note keeps the workspace-context handoff note visible for unusual layouts."
    "docs/ISSUE3_SAVED_MEMORY_INPUTS_ROUTE.md|docs/ISSUE3_RESTORED_HELPER_SURFACE_SYNC_ROUTE.md|The saved-Memory-inputs note keeps the restored-helper-surface sync handoff visible when restored snapshots may lag the live helper root."
    "docs/ISSUE3_SAVED_MEMORY_INPUTS_ROUTE.md|docs/ISSUE3_SAVED_RUST_TOOLCHAIN_ROUTE.md|The saved-Memory-inputs note keeps the saved Rust toolchain handoff visible."
    "docs/ISSUE3_SAVED_MEMORY_INPUTS_ROUTE.md|docs/ISSUE3_SAVED_RUST_BUILD_READINESS_ROUTE.md|The saved-Memory-inputs note keeps the saved Rust build-readiness handoff visible."
    "docs/ISSUE3_SAVED_MEMORY_INPUTS_ROUTE.md|docs/ISSUE3_SAVED_RUST_ARCHIVE_CANDIDATES_ROUTE.md|The saved-Memory-inputs note keeps the saved Rust archive candidate handoff visible."
    "docs/ISSUE3_SAVED_MEMORY_INPUTS_ROUTE.md|docs/ISSUE3_STAGED_RUST_TOOLCHAIN_CANDIDATES_ROUTE.md|The saved-Memory-inputs note keeps the staged Rust candidate handoff visible."
    ...
    "docs/ISSUE3_SAVED_MEMORY_INPUTS_ROUTE.md|run_issue11_nested_workspace_saved_memory_preflight.sh|The saved-Memory-inputs note keeps the compact issue #11 nested-workspace runner visible."
    "docs/ISSUE3_SAVED_MEMORY_INPUTS_ROUTE.md|--skip-archive-integrity-check|The saved-Memory-inputs note keeps the nested-runner quick-presence mode visible."
    "docs/ISSUE3_SAVED_MEMORY_INPUTS_ROUTE.md|check_issue3_workspace_context_route_surface.sh|The saved-Memory-inputs note keeps the workspace-context surface checker visible."
    "docs/ISSUE3_SAVED_MEMORY_INPUTS_ROUTE.md|show_issue3_workspace_context_route.sh|The saved-Memory-inputs note keeps the workspace-context route helper visible."
    "docs/ISSUE3_SAVED_MEMORY_INPUTS_ROUTE.md|python ./scripts/check_issue3_workspace_context.py --repo-root .|The saved-Memory-inputs note keeps the workspace-context helper command visible."
    "docs/ISSUE3_SAVED_MEMORY_INPUTS_ROUTE.md|check_issue3_restored_helper_surface_sync_route_surface.sh|The saved-Memory-inputs note keeps the narrower restored-helper sync surface checker visible."
    "docs/ISSUE3_SAVED_MEMORY_INPUTS_ROUTE.md|show_issue3_restored_helper_surface_sync_route.sh|The saved-Memory-inputs note keeps the narrower restored-helper sync route printer visible."
    "docs/ISSUE3_SAVED_MEMORY_INPUTS_ROUTE.md|check_issue3_restored_helper_surface_sync.py|The saved-Memory-inputs note keeps the narrower restored-helper sync helper visible."
    ...
    "docs/ISSUE3_SAVED_MEMORY_INPUTS_ROUTE.md|check_issue3_staged_zig_toolchain_candidates_route_surface.sh|The saved-Memory-inputs note keeps the staged Zig route surface checker visible."
    "docs/ISSUE3_SAVED_MEMORY_INPUTS_ROUTE.md|show_issue3_staged_zig_toolchain_candidates_route.sh|The saved-Memory-inputs note keeps the staged Zig route helper visible."
    "docs/ISSUE3_SAVED_MEMORY_INPUTS_ROUTE.md|check_issue3_staged_rust_toolchain_candidates_route_surface.sh|The saved-Memory-inputs note keeps the staged Rust route surface checker visible."
    "docs/ISSUE3_SAVED_MEMORY_INPUTS_ROUTE.md|show_issue3_staged_rust_toolchain_candidates_route.sh|The saved-Memory-inputs note keeps the staged Rust route helper visible."
    ...
    "scripts/linux/show_issue3_saved_memory_inputs_route.sh|docs/ISSUE3_RESTORED_HELPER_SURFACE_SYNC_ROUTE.md|The route printer keeps the restored-helper-surface sync note in the read-first surface."
    ...
    "scripts/linux/show_issue3_saved_memory_inputs_route.sh|run_issue11_nested_workspace_saved_memory_preflight.sh|The route printer exposes the compact issue #11 nested-workspace runner."
    "scripts/linux/show_issue3_saved_memory_inputs_route.sh|nested_workspace_saved_memory_preflight|The route printer JSON output exposes the nested-workspace runner command explicitly."
    "scripts/linux/show_issue3_saved_memory_inputs_route.sh|quick_nested_workspace_saved_memory_preflight|The route printer JSON output exposes the nested-workspace quick-presence runner command explicitly."
    "scripts/linux/show_issue3_saved_memory_inputs_route.sh|Issue #11 nested-workspace saved-Memory preflight:|The route printer prints the nested-workspace runner section explicitly."
    "scripts/linux/show_issue3_saved_memory_inputs_route.sh|Quick nested-workspace saved-Memory presence check:|The route printer prints the quick nested-workspace runner section explicitly."
    "scripts/linux/show_issue3_saved_memory_inputs_route.sh|show_issue3_restored_helper_surface_sync_route.sh|The route printer still exposes the restored-helper-surface sync follow-up."
    ...
    "scripts/linux/show_issue3_saved_memory_inputs_route.sh|Restored helper-surface sync route:|The route printer still prints the restored-helper-surface sync route section."
    ...
    "scripts/linux/show_issue3_saved_memory_inputs_route.sh|restored_helper_surface_sync_route|The route printer JSON output exposes the restored-helper-surface sync follow-up route explicitly."
