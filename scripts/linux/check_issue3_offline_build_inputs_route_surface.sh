...
declare -a REFERENCE_PATHS=(
    ...
    "docs/ISSUE3_SAVED_ARCHIVE_INTEGRITY_ROUTE.md|file|Saved-archive integrity note that should stay aligned with the offline build-inputs preflight."
    ...
    "scripts/check_issue3_saved_archive_integrity.py|file|Saved archive integrity helper used before trusting the offline restore commands."
...
declare -a CONTENT_EXPECTATIONS=(
    ...
    "docs/ISSUE3_OFFLINE_BUILD_INPUTS_ROUTE.md|scripts/check_issue3_saved_archive_integrity.py|The offline build-inputs note still points at the saved-archive integrity helper."
    ...
    "scripts/linux/show_issue3_offline_build_inputs_route.sh|scripts/check_issue3_saved_archive_integrity.py|The offline build-inputs route still points at the saved-archive integrity helper."
    ...
    "scripts/linux/show_issue3_offline_build_inputs_route.sh|Saved archive integrity preflight:|The offline build-inputs route still prints the saved-archive integrity step."
