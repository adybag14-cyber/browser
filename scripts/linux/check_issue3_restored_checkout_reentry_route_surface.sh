...
declare -a REFERENCE_PATHS=(
    ...
    "scripts/check_issue3_restored_helper_surface_sync.py|file|Narrow helper-surface sync checker that proves the restored checkout still carries the newer issue #11 re-entry routes."
...
declare -a CONTENT_EXPECTATIONS=(
    ...
    "docs/ISSUE3_RESTORED_CHECKOUT_REENTRY_ROUTE.md|scripts/check_issue3_restored_helper_surface_sync.py|The restored-checkout note still names the narrower helper-surface sync checker explicitly."
    ...
    "scripts/linux/show_issue3_restored_checkout_reentry_route.sh|RESTORED_HELPER_SURFACE_SYNC_COMMAND|The route printer still emits the narrower helper-surface sync command."
    ...
    "scripts/linux/show_issue3_restored_checkout_reentry_route.sh|Restored helper-surface sync check:|The route printer still prints a human-readable helper-surface sync step."
