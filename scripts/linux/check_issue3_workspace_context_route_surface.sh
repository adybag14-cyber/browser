...
declare -a REFERENCE_PATHS=(
    ...
    "docs/ISSUE3_SAVED_RUST_TOOLCHAIN_ROUTE.md|file|Saved-Rust route note that should stay visible when nested-checkout reruns still need the staged or restored Rust handoff."
    ...
    "docs/ISSUE3_SAVED_ZIG_ARCHIVE_CANDIDATES_ROUTE.md|file|Saved Zig archive candidates note that should stay visible when the next rerun needs a branch-compatible 0.15.x archive."
    ...
    "scripts/linux/check_issue3_saved_rust_toolchain_route_surface.sh|file|Saved-Rust route surface check used before the nested-checkout rerun trusts the Rust handoff."
    "scripts/linux/show_issue3_saved_rust_toolchain_route.sh|file|Saved-Rust route printer used when workspace discovery still needs a Rust restore or reuse step."
    "scripts/check_issue3_saved_rust_archive_candidates.py|file|Saved-Rust archive candidates helper used before a nested-checkout rerun unpacks the archive again."
    "scripts/check_issue3_staged_rust_toolchain_candidates.py|file|Staged-Rust candidate helper used before a nested-checkout rerun restores Rust again."
    ...
    "scripts/linux/check_issue3_saved_zig_archive_candidates_route_surface.sh|file|Saved Zig archive candidates surface check used before a rerun trusts branch-local archive discovery."
    "scripts/linux/show_issue3_saved_zig_archive_candidates_route.sh|file|Saved Zig archive candidates route printer used when the next rerun needs a branch-compatible restore target."
...
declare -a CONTENT_EXPECTATIONS=(
    ...
    "docs/ISSUE3_WORKSPACE_CONTEXT_ROUTE.md|docs/ISSUE3_SAVED_RUST_TOOLCHAIN_ROUTE.md|The workspace-context note keeps the saved-Rust route note visible."
    "docs/ISSUE3_WORKSPACE_CONTEXT_ROUTE.md|check_issue3_saved_rust_archive_candidates.py|The workspace-context note keeps the saved-Rust archive candidates helper visible."
    "docs/ISSUE3_WORKSPACE_CONTEXT_ROUTE.md|check_issue3_staged_rust_toolchain_candidates.py|The workspace-context note keeps the staged-Rust candidate helper visible."
    ...
    "docs/ISSUE3_WORKSPACE_CONTEXT_ROUTE.md|docs/ISSUE3_SAVED_ZIG_ARCHIVE_CANDIDATES_ROUTE.md|The workspace-context note keeps the saved-Zig candidates route note visible."
    ...
    "scripts/linux/show_issue3_workspace_context_route.sh|show_issue3_saved_rust_toolchain_route.sh|The route printer still exposes the saved-Rust follow-up."
    "scripts/linux/show_issue3_workspace_context_route.sh|check_issue3_saved_rust_archive_candidates.py|The route printer still exposes the saved-Rust archive candidates helper."
    "scripts/linux/show_issue3_workspace_context_route.sh|check_issue3_staged_rust_toolchain_candidates.py|The route printer still exposes the staged-Rust candidate helper."
    ...
    "scripts/linux/show_issue3_workspace_context_route.sh|check_issue3_saved_zig_archive_candidates_route_surface.sh|The route printer still exposes the saved-Zig route surface check."
    ...
    "scripts/linux/show_issue3_workspace_context_route.sh|docs/ISSUE3_SAVED_RUST_TOOLCHAIN_ROUTE.md|The route printer still keeps the saved-Rust route note visible in the read-first list."
    "scripts/linux/show_issue3_workspace_context_route.sh|docs/ISSUE3_SAVED_ZIG_ARCHIVE_CANDIDATES_ROUTE.md|The route printer still keeps the saved-Zig route note visible in the read-first list."
    "scripts/linux/show_issue3_workspace_context_route.sh|saved_rust_toolchain_route_surface|The route printer JSON output still exposes the saved-Rust route surface-check key."
    "scripts/linux/show_issue3_workspace_context_route.sh|saved_rust_toolchain_route|The route printer JSON output still exposes the saved-Rust route key."
    "scripts/linux/show_issue3_workspace_context_route.sh|saved_rust_archive_candidates|The route printer JSON output still exposes the saved-Rust archive candidates key."
    "scripts/linux/show_issue3_workspace_context_route.sh|staged_rust_toolchain_candidates|The route printer JSON output still exposes the staged-Rust candidates key."
