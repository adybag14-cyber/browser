...
declare -a CONTENT_EXPECTATIONS=(
    ...
    "docs/ISSUE3_SAVED_BROWSER_SNAPSHOT_ROUTE.md|Do not switch into the restored checkout|The saved-browser-snapshot note warns that the restored snapshot may not carry the newest route scripts."
    ...
    "scripts/linux/restore_saved_browser_snapshot.sh|Helper root:|The restore helper still prints the helper-root surface in its follow-up output."
    ...
    "scripts/linux/restore_saved_browser_snapshot.sh|show_issue3_linux_build_readiness_route.sh|The restore helper still anchors the Linux build-readiness follow-up to the live helper root."
    "scripts/linux/restore_saved_browser_snapshot.sh|show_issue3_enter_submit_runtime_revalidation_route.sh|The restore helper still anchors the runtime follow-up to the live helper root."
    ...
    "scripts/linux/show_issue3_saved_browser_snapshot_route.sh|helper_root|The route printer still exposes helper_root in JSON output for downstream tooling."
    "scripts/linux/show_issue3_saved_browser_snapshot_route.sh|Helper root:|The route printer still prints the live helper-root surface in text output."
    ...
    "scripts/linux/show_issue3_saved_browser_snapshot_route.sh|show_issue3_enter_submit_runtime_revalidation_route.sh --repo-root|The route printer still prints the direct runtime follow-up."
    ...
    "scripts/linux/show_issue3_saved_browser_snapshot_route.sh|live branch-local helper surface|The route printer still explains why the follow-up helpers stay anchored to the live checkout."
