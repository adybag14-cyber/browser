...
declare -a REFERENCE_PATHS=(
    ...
    "docs/ISSUE3_RESTORED_HELPER_SURFACE_SYNC_ROUTE.md|file|Narrower restored-helper sync note that should stay visible after a synced restore or sync-only refresh."
    ...
    "scripts/check_issue3_restored_helper_surface_sync.py|file|Narrower restored-helper sync helper that should run before the restored checkout becomes its own helper root."
    "scripts/linux/check_issue3_restored_helper_surface_sync_route_surface.sh|file|Fail-fast surface checker for the narrower restored-helper sync route."
    "scripts/linux/show_issue3_restored_helper_surface_sync_route.sh|file|Compact route printer for the narrower restored-helper sync route."
...
declare -a CONTENT_EXPECTATIONS=(
    ...
    "docs/ISSUE3_SAVED_BROWSER_SNAPSHOT_ROUTE.md|docs/ISSUE3_RESTORED_HELPER_SURFACE_SYNC_ROUTE.md|The saved-browser-snapshot note keeps the narrower restored-helper sync note visible after synced restore."
    "docs/ISSUE3_SAVED_BROWSER_SNAPSHOT_ROUTE.md|check_issue3_restored_helper_surface_sync.py|The saved-browser-snapshot note keeps the narrower restored-helper sync helper visible before broader follow-up helpers are trusted from the restored checkout."
    ...
    "scripts/linux/show_issue3_saved_browser_snapshot_route.sh|show_issue3_restored_helper_surface_sync_route.sh|The route printer exposes the narrower restored-helper sync route after synced restore."
    "scripts/linux/show_issue3_saved_browser_snapshot_route.sh|check_issue3_restored_helper_surface_sync.py|The route printer exposes the narrower restored-helper sync helper after synced restore."
    ...
    "scripts/linux/show_issue3_saved_browser_snapshot_route.sh|sync_route|The route printer exposes the restored-helper sync route command in JSON output for downstream tooling."
    "scripts/linux/show_issue3_saved_browser_snapshot_route.sh|sync_check|The route printer exposes the restored-helper sync helper command in JSON output for downstream tooling."
