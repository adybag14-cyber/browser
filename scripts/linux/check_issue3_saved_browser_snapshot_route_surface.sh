...
declare -a CONTENT_EXPECTATIONS=(
    ...
    "docs/ISSUE3_SAVED_BROWSER_SNAPSHOT_ROUTE.md|docs/ISSUE3_RESTORED_CHECKOUT_REENTRY_ROUTE.md|The saved-browser-snapshot note keeps the restored-checkout re-entry note visible."
    ...
    "docs/ISSUE3_SAVED_BROWSER_SNAPSHOT_ROUTE.md|python ./scripts/check_issue3_restored_checkout.py --repo-root ../browser-memory-snapshot|The saved-browser-snapshot note keeps the live-helper restored-checkout check visible."
    "docs/ISSUE3_SAVED_BROWSER_SNAPSHOT_ROUTE.md|python ../browser-memory-snapshot/scripts/check_issue3_restored_checkout.py --repo-root ../browser-memory-snapshot --helper-root . --expect-helper-surface|The saved-browser-snapshot note keeps the synced restored-checkout readiness check visible."
    "docs/ISSUE3_SAVED_BROWSER_SNAPSHOT_ROUTE.md|Run the restored-checkout readiness check first|The saved-browser-snapshot note explains that restored-checkout validation must happen before archive-focused preflights."
    ...
    "docs/ISSUE3_SAVED_BROWSER_SNAPSHOT_ROUTE.md|python ./scripts/check_issue3_saved_archive_integrity.py --repo-root ../browser-memory-snapshot|The saved-browser-snapshot note keeps the live-helper saved-archive integrity check visible."
    "docs/ISSUE3_SAVED_BROWSER_SNAPSHOT_ROUTE.md|python ../browser-memory-snapshot/scripts/check_issue3_saved_archive_integrity.py --repo-root ../browser-memory-snapshot|The saved-browser-snapshot note keeps the synced saved-archive integrity check visible."
    "docs/ISSUE3_SAVED_BROWSER_SNAPSHOT_ROUTE.md|Run the saved-archive integrity check immediately after|The saved-browser-snapshot note explains that archive integrity follows the saved-Memory preflight before deeper staging."
    ...
    "scripts/linux/restore_saved_browser_snapshot.sh|follow_up_restored_checkout_check|The restore helper still exposes the restored-checkout follow-up in JSON output."
    ...
    "scripts/linux/restore_saved_browser_snapshot.sh|follow_up_archive_integrity_check|The restore helper still exposes the saved-archive integrity follow-up in JSON output."
    ...
    "scripts/linux/show_issue3_saved_browser_snapshot_route.sh|check_issue3_restored_checkout.py|The route printer still prints the restored-checkout readiness helper."
    "scripts/linux/show_issue3_saved_browser_snapshot_route.sh|check_issue3_saved_archive_integrity.py|The route printer still prints the saved-archive integrity helper."
    "scripts/linux/show_issue3_saved_browser_snapshot_route.sh|Restored-checkout readiness check:|The route printer still prints the restored-checkout follow-up step."
    "scripts/linux/show_issue3_saved_browser_snapshot_route.sh|Synced restored-checkout readiness check:|The route printer keeps the synced restored-checkout follow-up visible."
    "scripts/linux/show_issue3_saved_browser_snapshot_route.sh|Saved-archive integrity preflight against the restored checkout:|The route printer still prints the saved-archive integrity preflight step."
    "scripts/linux/show_issue3_saved_browser_snapshot_route.sh|Synced saved-archive integrity preflight:|The route printer keeps the synced saved-archive integrity preflight visible for self-contained restores."
    ...
    "scripts/linux/show_issue3_saved_browser_snapshot_route.sh|restored_checkout_check|The route printer still exposes the restored-checkout check in JSON output for downstream tooling."
