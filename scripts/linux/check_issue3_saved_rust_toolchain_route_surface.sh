...
declare -a CONTENT_EXPECTATIONS=(
    ...
    "scripts/linux/show_issue3_saved_rust_toolchain_route.sh|Saved Rust restore surface check:|The saved Rust route printer still prints the restore helper surface-check step."
