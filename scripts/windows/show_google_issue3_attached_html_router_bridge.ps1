...
$helper = [ordered]@{
    ...
    purpose = 'Print the direct helper chain from show_headed_validation_suites.ps1 -ChangeArea attached-html into the newer issue #3 change-area quickstart, the broader attached-page flow helper, and the narrower top-level attached-page follow-up commands.'
    repo_root = $RepoRoot
