...
Write-Host "Repair the missing replay-route note, higher-level replay companion, helper output contract, attached-page helper, replay-side bridge, bundle-aware follow-up, proof-note companion, or safe-route companion before trusting this compact issue #3 replay-route branch."
exit 1