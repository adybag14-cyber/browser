...
$helper = [ordered]@{
    ...
    notes = @(
        ...
        'Keep discovery_handoff_note_path open for the shortest prose bridge from the top-level suite catalog into the newer suite-router handoff and replay-route helpers, quickstart_note_path for the shortest replay note, suite_router_attached_html_quickstart_note_path for the shorter suite-router attached-page bridge, top_level_attached_html_quickstart_note_path, top_level_attached_html_bridge_note_path, and top_level_attached_html_catalog_quickstart_note_path for the compact, broader, and catalog-flavored top-level attached-page companion notes, validation_router_attached_html_quickstart_note_path, suite_catalog_entrypoint_note_path, suite_catalog_attached_html_bridge_note_path, and windows_replay_attached_html_quickstart_note_path when the replay needs the wider validation-router, suite-catalog, or Windows replay attached-page companions, suite_router_bridge_note_path for the narrower prose bridge, replay_route_shortcut_bridge_note_path for the shorter replay-route companion note, google_attached_html_entrypoint_note_path and google_attached_html_validation_flow_note_path for the narrower Google-shaped attached-page route, validation_chain_note_path for wrapper precedence and context-preserving lane handoffs, decision_table_note_path when the replay lands on ready-for-runner-patch, already-direct, or runner-already-wired-regenerate-outputs, and windows_runbook_path when the next replay should widen back into the broader attached or saved localhost HTML follow-up.'
    )
}
