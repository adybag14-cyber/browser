...
Write-Host "Repair the missing compact top-level note, attached-page companion, helper surface, issue-specific Google checker surfacing, or bundle fallback before trusting this issue #3 attached-page route."
exit 1
