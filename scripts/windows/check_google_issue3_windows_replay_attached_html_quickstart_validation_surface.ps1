...
Write-Host "Repair the missing route note, helper, suite-catalog fail-fast block, attached-bundle surface, proof-only bundle follow-up, bundle-first route, or replay-side helper-output contract before trusting the issue #3 Windows replay attached-html quickstart."
exit 1