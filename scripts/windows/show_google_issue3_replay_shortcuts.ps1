...
$shortcuts = [ordered]@{
    ...
    notes = @(
        ...
        'Use contextual_flow when you already know repo-root overrides, saved-summary state, or pinned attached pages should stay visible while you choose between the recommended runner, replay shortcuts, the replay-shortcuts-to-Windows-replay bridge, the Windows replay attached-page quickstart, the Windows full-use attached-page route, the Windows full-use validation-router attached-page bridge, the Windows full-use attached-page catalog quickstart, the attached-html change-area quickstart, the top-level attached-page quickstart, the top-level attached-page bridge, the top-level attached-page catalog quickstart, attached-page shortcut, live trace, or bundle follow-up commands.',
