...
$shortcuts = [ordered]@{
    ...
    purpose = 'Keep the top-level issue #3 read-first commands, the Windows full-use attached-page route, the Windows full-use validation-router attached-page bridge, the Windows full-use attached-page catalog quickstart, the replay-shortcuts-to-Windows-replay attached-page bridge, the Windows replay attached-page quickstart, the broader attached-page route, the broader attached-page flow helper, the Google-style attached-page flow helper, the attached-html change-area quickstart, the newer top-level attached-page quickstart and top-level attached-page catalog quickstart, the broader top-level attached-page bridge, the dedicated attached-page shortcut helper, the newer suite-router shortcut-first entrypoint, the suite-catalog bridge, the compact next-step matrix, the context-preserving helper, the narrower safe-route helper, the attached three-page bundle route, and the runner-state next-step helper on one compact command surface.'
    repo_root = $RepoRoot
    ...
    notes = @(
        ...
        'Use suite_router_handoff when you want the higher-level suite-router entrypoints, the Windows full-use attached-page route, the Windows full-use validation-router attached-page bridge, the Windows full-use attached-page catalog quickstart, the replay-shortcuts-to-Windows-replay bridge, the Windows replay attached-page quickstart, the attached-page route, the broader attached-page flow helper, the Google-style attached-page flow helper, the attached-html change-area quickstart, the top-level attached-page quickstart, the top-level attached-page bridge, the top-level attached-page catalog quickstart, the shortcut-first suite-router entrypoint, the suite-catalog bridge, and the current replay-shortcuts helper reprinted together in one compact surface before you drop into the next-step matrix, replay-route, attached-page shortcut, contextual-flow, safe-route, or bundle-first helpers.',
        'Use suite_router_next_steps when you want the compact next-step matrix that keeps the current start points, the Windows-first attached-page route, the Windows validation-router bridge, the Windows-full-use catalog bridge, the replay-shortcuts-to-Windows-replay bridge, the Windows replay attached-page quickstart, the attached-page route, the broader attached-page flow helper, the Google-style attached-page flow helper, the attached-html change-area quickstart, the top-level attached-page quickstart, the top-level attached-page bridge, the top-level attached-page catalog quickstart, the shortcut-first suite-router bridge, replay-route branch, attached-bundle branch, contextual-flow branch, and runner-state helper choices together before you pick one narrower replay path.',
        ...
        'Use contextual_flow when you already know repo-root overrides, saved-summary state, or pinned attached pages should stay visible while you choose between the recommended runner, replay shortcuts, the replay-shortcuts-to-Windows-replay bridge, the Windows replay attached-page quickstart, the Windows full-use attached-page route, the Windows full-use validation-router attached-page bridge, the Windows full-use attached-page catalog quickstart, the broader attached-page flow helper, the Google-style attached-page flow helper, the attached-html change-area quickstart, the top-level attached-page quickstart, the top-level attached-page bridge, the top-level attached-page catalog quickstart, attached-page shortcut, live trace, or bundle follow-up commands.',
