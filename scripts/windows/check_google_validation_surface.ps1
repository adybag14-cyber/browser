...
$profiles = @{
    "issue3" = @(
        ...
        (New-ValidationReference -Path "docs/GOOGLE_SHARED_ENTER_ORDER_VALIDATION.md" -Kind "file" -Purpose "Dedicated shared Enter-order note referenced by the main Windows guide."),
        ...
        (New-ValidationReference -Path "scripts/windows/show_google_trace_validation_flow.ps1" -Kind "file" -Purpose "Live Google trace handoff helper referenced by the main Windows guide."),
