...
Write-Host "Repair the missing guide, shortcut, suite-catalog helper, runner, or asset-audit script before trusting the Google-style attached-HTML follow-up."
exit 1
