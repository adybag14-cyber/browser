...
$guide = [ordered]@{
    ...
    next_step = 'Run the dedicated title surface checker first, then the title wrapper, and only move to the quick, reduced homepage, submit-timing, or shared Enter-order helpers after the title markers make the failing stage obvious.'
}
