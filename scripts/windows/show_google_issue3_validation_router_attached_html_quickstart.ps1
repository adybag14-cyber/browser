...
$helper = [ordered]@{
    ...
    commands = [ordered]@{
        ...
        top_level_attached_html_surface_check = Format-HelperCommandWithRepoRootEnv -ScriptName 'check_google_issue3_top_level_attached_html_entrypoint_validation_surface.ps1' -RepoRootOverride $RepoRoot
