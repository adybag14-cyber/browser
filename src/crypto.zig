...
pub extern fn EVP_PKEY_keygen(ctx: ?*EVP_PKEY_CTX, ppkey: *?*EVP_PKEY) c_int;
pub extern fn EVP_PKEY_get_raw_public_key(pkey: ?*const EVP_PKEY, out: [*c]u8, len: *usize) c_int;
pub extern fn EVP_PKEY_get_raw_private_key(pkey: ?*const EVP_PKEY, out: [*c]u8, len: *usize) c_int;
