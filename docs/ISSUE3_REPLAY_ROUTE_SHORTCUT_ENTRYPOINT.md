...
1. `show_attached_html_validation_flow.ps1`

Use this when the route still needs the broader attached-page localhost flow reprinted before it narrows again.

2. `show_google_attached_html_validation_flow.ps1`

Use this when the current attached inputs are already Google-shaped and you want that narrower attached-page flow guide visible before the shorter issue `#3` helpers take over.
...
5. `show_google_issue3_replay_shortcuts_windows_replay_attached_html_bridge.ps1`

Use this when the replay-route shortcut still needs the replay-side bridge, quick check, and Windows replay attached-page quickstart visible before it collapses back to the shorter helper chain.

6. `check_google_issue3_windows_replay_attached_html_quickstart_validation_surface.ps1`

Use this when you want the narrower Windows replay attached-page ladder to fail fast before trusting it.

7. `show_google_issue3_windows_replay_attached_html_quickstart.ps1`

Use this when the replay-route shortcut already confirmed attached-page follow-up and you want the shorter Windows replay ladder visible before you widen back into broader issue `#3` helpers.
