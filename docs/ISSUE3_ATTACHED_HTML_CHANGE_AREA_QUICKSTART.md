...
Keep these helper surfaces nearby too:
...
3. Attached-pages launcher companion surface check plus helper
...
Use this when branch state may have moved and you want the issue-specific attached-page helper surface checked after the launcher companion has already ruled out the lighter preflight failures.
...
13. Replay shortcuts, next-step matrix, or safe-route entrypoints
