...
`docs/ISSUE3_WINDOWS_FULL_USE_VALIDATION_ROUTER_ATTACHED_HTML_BRIDGE.md`, and
`docs/ISSUE3_WINDOWS_REPLAY_ATTACHED_HTML_QUICKSTART.md` nearby and reopen the
...
Windows-to-validation-router bridge, and the replay-side attached-html
quickstart visible before the route narrows into the smaller top-level
...
- Use `docs/ISSUE3_WINDOWS_FULL_USE_ATTACHED_HTML_ROUTE.md`, `docs/ISSUE3_WINDOWS_FULL_USE_VALIDATION_ROUTER_ATTACHED_HTML_BRIDGE.md`, and `docs/ISSUE3_WINDOWS_REPLAY_ATTACHED_HTML_QUICKSTART.md` plus `show_google_issue3_windows_full_use_attached_html_route.ps1`, `check_google_issue3_windows_full_use_attached_html_route_validation_surface.ps1`, `show_google_issue3_windows_full_use_validation_router_attached_html_bridge.ps1`, and `show_google_issue3_windows_replay_attached_html_quickstart.ps1` when `docs/WINDOWS_FULL_USE.md` already narrowed the replay to attached localhost follow-up and you want the route-level surface check, the broader Windows-side attached-page bridge, and the replay-side quickstart visible before the helper chain narrows again.
