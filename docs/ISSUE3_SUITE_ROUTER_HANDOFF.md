...
If the replay is already narrowed to the issue-specific Google-shaped attached-page follow-up and you want the shortest handoff through the dedicated checker and flow before returning to replay shortcuts or the next-step matrix, use:
...
Use that route when the issue-specific Google-shaped attached-page branch is already clear and you want the issue-specific fail-fast checker, the dedicated Google attached-page flow helper, the issue-specific attached-page bridge, the suite-router-side attached-page bridge, and the narrower replay-shortcuts surface kept aligned on one smaller handoff.
...
Use this when the issue-specific Google-shaped attached-page branch is already clear and you want the dedicated flow helper surfaced before deciding whether to reopen the narrower attached-page bridge, replay shortcuts, the next-step matrix, or the suite-catalog guide.

4. `show_google_issue3_google_attached_html_entrypoint.ps1`

Use this when the issue-specific Google attached-page bridge should stay visible beside the dedicated checker and flow helper before the route narrows again.
...
Use this when the route is already narrowed to the suite-router-side attached-page bridge and you want that shorter attached-page handoff reprinted before jumping to the top-level quickstart, the dedicated Google attached-page checker and flow, the shortcut-first entrypoint, or replay shortcuts.
...
10. `show_google_issue3_suite_catalog_entrypoints.ps1`
...
12. `show_google_issue3_replay_route.ps1`
...
13. `show_google_issue3_replay_route_shortcut_entrypoint.ps1`
