...
- you still want the broader Windows route, the Windows-to-validation-router bridge, and the Windows-side catalog step visible before the helper surface narrows further
