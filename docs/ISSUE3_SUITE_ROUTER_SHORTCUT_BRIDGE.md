...
The shortcut-first helper now also keeps the broader attached-page localhost flow, the narrower Google-shaped attached-page flow, the dedicated attached-page shortcut, the slightly broader replay-route helper, and the smaller replay-route shortcut surface visible beside the replay-shortcuts ladder, so this note should stay aligned with those surfaced follow-up helpers too.
