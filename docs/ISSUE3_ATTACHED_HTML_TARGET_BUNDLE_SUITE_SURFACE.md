...
- you want the top-level attached-page bridge, the dedicated suite-surface helper, the bundle-first helper, and the replay-route helpers aligned with the same broader catalog-first route that the surrounding bundle-reference and roadmap notes already describe
