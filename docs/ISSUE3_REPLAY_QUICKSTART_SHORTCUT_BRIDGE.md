...
If the replay is already narrowed to the attached localhost HTML route and you want the shorter attached-page bridge kept visible before widening back into the broader helper chain, use:
