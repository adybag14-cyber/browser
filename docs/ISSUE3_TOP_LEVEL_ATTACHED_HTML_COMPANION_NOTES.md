...
When the next rerun is already pinned to the known three-page compatibility bundle, keep the replay-route bundle-first bridge, the compact bundle-suite surface, the compact bundle quickstart, and the pinned manual checklist on the same written surface before widening back into the broader attached-page note family.
