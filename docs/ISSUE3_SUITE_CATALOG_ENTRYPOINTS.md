...
attached-page flow helper, the validation-router attached-page quickstart, the
...
attached-page quickstart, the top-level attached-page quickstarts, and the
top-level shortcut-first bridge printed before the replay falls back into the
narrower attached-page helper chain.
