...
- the broader attached-page flow helper should stay pinned to that same attached-page set before the route narrows into the dedicated Google-shaped helper or the smaller suite-catalog bridges
