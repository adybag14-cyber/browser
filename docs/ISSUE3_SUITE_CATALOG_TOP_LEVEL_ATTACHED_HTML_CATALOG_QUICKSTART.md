...
- you still want the replay-side attached HTML quickstart, the validation-router bridge, the compact top-level attached-page quickstart, the broader top-level attached-page bridge, and the top-level attached-page catalog quickstart visible before the route commits to the suite-catalog or suite-router attached-page bridges
...
- you want the Windows-side route, the replay-side attached HTML quickstart, the validation-router bridge, the top-level attached-page notes, and this suite-catalog-to-top-level catalog quickstart describing the same handoff order
...
- saved summary or repo-root override already present: reopen this quickstart with that same context first, then choose the suite-catalog bridge, replay shortcuts, the next-step matrix, contextual flow, or the safe-route map only as needed
