...
- replay-route already open and explicit bundle paths already pinned: go from the replay-route helper to the replay-route shortcut, then the bundle-first helper, then the bundle flow helper, then the delegated runner, then the fixed-list proof path
