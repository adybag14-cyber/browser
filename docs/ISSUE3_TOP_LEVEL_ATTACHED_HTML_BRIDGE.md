...
`docs/ISSUE3_GOOGLE_ATTACHED_HTML_VALIDATION_FLOW.md` nearby so the Google-like
fixture route stays visible before the top-level helper chain narrows again:
